...
## Project Structure
    ...
    ├── sparkling_waterfall_43965  # Django project configurations
...
1. Clone this repo and `cd sparkling_waterfall_43965`
...
2. Clone this repo and `cd sparkling_waterfall_43965`
